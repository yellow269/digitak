...
('AI & Technology', 'ai-and-technology', 'Artificial intelligence tools, machine learning platforms, and cutting-edge tech products.', 'AI & Technology Digital Products | DigitalVault SA', 'Discover AI tools, machine learning platforms and tech products curated for South African creators.', 1),
('Make Money Online', 'make-money-online', 'Courses, systems and resources for earning income online.', 'Make Money Online Products | DigitalVault SA', 'Explore vetted products and courses for building online income streams.', 2),
('Business', 'business', 'Business tools, templates and resources for entrepreneurs.', 'Business Digital Products | DigitalVault SA', 'Business templates, tools and resources for entrepreneurs and small businesses.', 3),
('Marketing', 'marketing', 'Digital marketing courses, tools and templates.', 'Marketing Digital Products | DigitalVault SA', 'Marketing courses, automation tools and templates to grow your audience.', 4),
('Software', 'software', 'Productivity software, SaaS tools and applications.', 'Software Digital Products | DigitalVault SA', 'Productivity software, SaaS tools and applications for professionals.', 5),
('Personal Development', 'personal-development', 'Self-improvement courses, ebooks and programs.', 'Personal Development Products | DigitalVault SA', 'Self-improvement courses, ebooks and coaching programs.', 6),
('Education', 'education', 'Online courses, learning platforms and educational resources.', 'Education Digital Products | DigitalVault SA', 'Online courses and learning resources across many subjects.', 7),
('Health & Fitness', 'health-and-fitness', 'Fitness programs, nutrition guides and wellness products.', 'Health & Fitness Digital Products | DigitalVault SA', 'Fitness programs, nutrition guides and wellness resources.', 8),
('Lifestyle', 'lifestyle', 'Lifestyle, hobbies and personal interest digital products.', 'Lifestyle Digital Products | DigitalVault SA', 'Lifestyle and hobby digital products for everyday life.', 9),
('Finance', 'finance', 'Personal finance, investing and money management resources.', 'Finance Digital Products | DigitalVault SA', 'Personal finance, investing and money management resources.', 10),
('Ebooks', 'ebooks', 'Digital books across every category.', 'Ebooks | DigitalVault SA', 'Digital books and ebooks across every category.', 11),
('Courses', 'courses', 'Online courses and training programs.', 'Courses | DigitalVault SA', 'Online courses and training programs from trusted creators.', 12),
('Templates', 'templates', 'Reusable templates for design, business and productivity.', 'Templates | DigitalVault SA', 'Reusable templates for design, business and productivity.', 13),
('Other Digital Products', 'other-digital-products', 'Digital products that don''t fit elsewhere.', 'Other Digital Products | DigitalVault SA', 'Other digital products and resources worth your time.', 14)
...
'AI Copywriter Pro — AI Writing Assistant | DigitalVault SA', 'AI Copywriter Pro is a demo AI writing assistant for marketers. This is a demo product.', now() - interval '2 days')
ON CONFLICT (slug) DO NOTHING;
...
'Affiliate Income Blueprint — Online Income Course | DigitalVault SA', 'Affiliate Income Blueprint is a demo course on building affiliate income. This is a demo product.', now() - interval '5 days')
ON CONFLICT (slug) DO NOTHING;
...
'Business Plan Template Pack | DigitalVault SA', 'A demo pack of 20 editable business plan templates. This is a demo product.', now() - interval '8 days')
ON CONFLICT (slug) DO NOTHING;
...
'Social Media Marketing Mastery Course | DigitalVault SA', 'A demo social media marketing course for small businesses. This is a demo product.', now() - interval '3 days')
ON CONFLICT (slug) DO NOTHING;
...
'TaskFlow Project Management App | DigitalVault SA', 'A demo project management app for freelancers and teams. This is a demo product.', now() - interval '10 days')
ON CONFLICT (slug) DO NOTHING;
...
'Productivity Habits Ebook | DigitalVault SA', 'A demo ebook on building productive habits. This is a demo product.', now() - interval '14 days')
ON CONFLICT (slug) DO NOTHING;
...
'Web Development Bootcamp 2026 | DigitalVault SA', 'A demo full-stack web development bootcamp. This is a demo product.', now() - interval '1 days')
ON CONFLICT (slug) DO NOTHING;
...
'12-Week Home Fitness Program | DigitalVault SA', 'A demo 12-week home fitness program. This is a demo product.', now() - interval '6 days')
ON CONFLICT (slug) DO NOTHING;
...
'Personal Finance Dashboard Notion Template | DigitalVault SA', 'A demo Notion personal finance dashboard template. This is a demo product.', now() - interval '11 days')
ON CONFLICT (slug) DO NOTHING;
...
'Notion Productivity OS Template | DigitalVault SA', 'A demo all-in-one Notion productivity template. This is a demo product.', now() - interval '4 days')
ON CONFLICT (slug) DO NOTHING;
...
> This article contains affiliate links. DigitalVault SA may earn a commission if you purchase through one of our links.',
'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=1200',
'AI Tools', 'DigitalVault SA Team', '["ai","tools","2026"]', '[]',
'10 AI Tools Worth Trying in 2026 | DigitalVault SA', 'A curated look at ten AI tools shaping productivity and creativity in 2026.',
...
'Online Business', 'DigitalVault SA Team', '["digital products","entrepreneurs"]', '[]',
'Best Digital Products for Online Entrepreneurs | DigitalVault SA', 'Our picks for useful digital products for online entrepreneurs.',
...
'AI Tools', 'DigitalVault SA Team', '["ai","small business"]', '[]',
'Best AI Tools for Small Businesses | DigitalVault SA', 'Affordable AI tools that help small businesses do more with less.',
...
'Tutorials', 'DigitalVault SA Team', '["courses","education"]', '[]',
'How to Choose the Right Online Course | DigitalVault SA', 'A practical framework for picking a worthwhile online course.',
...
'Software', 'DigitalVault SA Team', '["software","freelancers"]', '[]',
'Best Software Tools for Freelancers | DigitalVault SA', 'Essential software tools every freelancer should consider.',
