...
export const PUBLIC_PRODUCT_COLUMNS =
  'id, name, slug, short_description, description, benefits, category_id, vendor_name, image_url, price, sale_price, currency, rating, review_count, featured, status, product_type, stock_status, shipping_estimate, selling_price, created_at, updated_at, category:categories(*)';
